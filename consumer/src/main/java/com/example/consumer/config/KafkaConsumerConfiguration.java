...
import com.example.consumer.service.impl.MessageServiceImpl;
...
public class KafkaConsumerConfiguration {
    ...
    public KafkaListenerContainerFactory<?> batchFactory() {
        ConcurrentKafkaListenerContainerFactory<Long, RateModel> factory =
    ...
    @Bean
    public ConsumerFactory<Long, RateModel> consumerFactory() {
